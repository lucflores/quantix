    ...
    <div className="app-container bg-white d-flex">
      ...
      <div className="sidebar d-flex flex-column flex-shrink-0 p-3 bg-light border-end">
        ...
        <ul className="nav nav-pills flex-column mb-auto">
          ...
          <li>
            <Link to="/dashboard/products" className="nav-link text-dark">
          ...
          <li className="nav-item dropdown">
            ...
            >
              <li>
                <Link className="dropdown-item" to="/dashboard/stock">
                  Control de stock
                </Link>
              </li>
              <li>
                <Link className="dropdown-item" to="/dashboard/movements">
                  Movimientos
                </Link>
              </li>
            </ul>
